        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="#">Поддержка</a>
                    <ul>
                        <li><a href="tabel_ocenok_teacher.php">Табель оценок</a></li>
                    </ul>
                </li>
            ...
            <main>
                <div class="info-container">
                    <?php
                        ...
                        $login = $_GET['var_name'];
                        $query = "SELECT name, surname, patronymic, date, class, id_predmeta, post, email FROM teacher WHERE snils = '$login'";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            if ($predmetaResult->num_rows > 0) {
                                $predmetaRow = $predmetaResult->fetch_assoc();
                                echo '<div class="info"><label for="id_predmeta">Преподаваемый предмет:</label><span>' . $predmetaRow['predmet'] . '</span></div>';
                            } else {
                                echo '<div class="info"><label for="id_predmeta">Преподаваемый предмет:</label><span>Информация о предмете не найдена</span></div>';
                            }
